Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.3"
  spec.summary      = "Added TTGSnackbar as dependency module"
  ...
  spec.homepage     = "https://github.com/isoneday/CostumRoundedButton.git"
  ...
  spec.source       = { :git => "https://github.com/isoneday/CostumRoundedButton.git", :tag => "#{spec.version}" }

	# Replace value of source file with your Path
  spec.source_files  = "OnedayFramework/**/*.{swift}"
